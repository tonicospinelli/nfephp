 ...
 *
 */
class NFePHPRequirements extends RequirementCollection
{
    ...
    public function __construct()
    {
        ...
        $this->addRequirement(
            version_compare($installedPhpVersion, '5.3.0', '!='),
            'PHP version must not be 5.3.0 as Symfony won\'t work properly with it',
